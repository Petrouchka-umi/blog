...
# programming_1 = programming.children.create(name: "Ruby")
# programming_2 = programming.children.create(name: "javascript")
# programming_3 = programming.children.create(name: "HTML/CSS")
